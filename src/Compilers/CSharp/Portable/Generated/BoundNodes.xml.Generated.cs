...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal enum BoundKind : byte
    {
        ...
        UnconvertedInferredObjectCreationExpression,
    ...
    internal sealed partial class BoundCall : BoundExpression
    {
        ...
        public BoundCall Update(BoundExpression? receiverOpt, MethodSymbol method, ImmutableArray<BoundExpression> arguments, ImmutableArray<string> argumentNamesOpt, ImmutableArray<RefKind> argumentRefKindsOpt, bool isDelegateCall, bool expanded, bool invokedAsExtensionMethod, ImmutableArray<int> argsToParamsOpt, BitVector defaultArguments, LookupResultKind resultKind, ImmutableArray<MethodSymbol> originalMethodsOpt, ImmutableArray<TypeWithAnnotations> originalTypeArgsOpt, TypeSymbol type)
        {
            ...
            {
                var result = new BoundCall(this.Syntax, receiverOpt, method, arguments, argumentNamesOpt, argumentRefKindsOpt, isDelegateCall, expanded, invokedAsExtensionMethod, argsToParamsOpt, defaultArguments, resultKind, originalMethodsOpt, originalTypeArgsOpt, type, this.HasErrors);
                result.CopyAttributes(this);
                return result;
            }
            return this;
    ...
    internal sealed partial class BoundObjectCreationExpression : BoundObjectCreationExpressionBase
    {
        ...
        public ImmutableArray<TypeWithAnnotations> OriginalTypeArgsOpt { get; }
        public bool HasDiamondOperator { get; }
        ...
        internal R VisitInternal(BoundNode node, A arg)
        {
            switch (node.Kind)
            {
                ...
                case BoundKind.UnconvertedInferredObjectCreationExpression:
                    return VisitUnconvertedInferredObjectCreationExpression((BoundUnconvertedInferredObjectCreationExpression)node, arg);
    ...
    internal abstract partial class BoundTreeVisitor<A, R>
    {
        ...
        public virtual R VisitUnconvertedInferredObjectCreationExpression(BoundUnconvertedInferredObjectCreationExpression node, A arg) => this.DefaultVisit(node, arg);
    ...
    internal abstract partial class BoundTreeVisitor
    {
        ...
        public virtual BoundNode? VisitUnconvertedInferredObjectCreationExpression(BoundUnconvertedInferredObjectCreationExpression node) => this.DefaultVisit(node);
    ...
    internal abstract partial class BoundTreeWalker : BoundTreeVisitor
    {
        ...
        public override BoundNode? VisitUnconvertedInferredObjectCreationExpression(BoundUnconvertedInferredObjectCreationExpression node) => null;
    ...
    internal abstract partial class BoundTreeRewriter : BoundTreeVisitor
    {
        ...
        public override BoundNode? VisitUnconvertedInferredObjectCreationExpression(BoundUnconvertedInferredObjectCreationExpression node)
        {
        ...
        public override BoundNode? VisitObjectCreationExpression(BoundObjectCreationExpression node)
        {
            ...
            TypeSymbol? type = this.VisitType(node.Type);
            return node.Update(node.Constructor, node.ConstructorsGroup, arguments, node.ArgumentNamesOpt, node.ArgumentRefKindsOpt, node.Expanded, node.ArgsToParamsOpt, node.DefaultArguments, node.ConstantValueOpt, initializerExpressionOpt, node.WasTargetTyped, node.OriginalTypeArgsOpt, node.HasDiamondOperator, type);
        }
        public override BoundNode? VisitTupleLiteral(BoundTupleLiteral node)
        {
            ImmutableArray<BoundExpression> arguments = this.VisitList(node.Arguments);
    ...
    internal sealed partial class NullabilityRewriter : BoundTreeRewriter
    {
        ...
        public override BoundNode? VisitCall(BoundCall node)
        {
            ...
            if (_updatedNullabilities.TryGetValue(node, out (NullabilityInfo Info, TypeSymbol? Type) infoAndType))
            {
                updatedNode = node.Update(receiverOpt, method, arguments, node.ArgumentNamesOpt, node.ArgumentRefKindsOpt, node.IsDelegateCall, node.Expanded, node.InvokedAsExtensionMethod, node.ArgsToParamsOpt, node.DefaultArguments, node.ResultKind, node.OriginalMethodsOpt, node.OriginalTypeArgsOpt, infoAndType.Type!);
                updatedNode.TopLevelNullability = infoAndType.Info;
            }
            else
            {
                updatedNode = node.Update(receiverOpt, method, arguments, node.ArgumentNamesOpt, node.ArgumentRefKindsOpt, node.IsDelegateCall, node.Expanded, node.InvokedAsExtensionMethod, node.ArgsToParamsOpt, node.DefaultArguments, node.ResultKind, node.OriginalMethodsOpt, node.OriginalTypeArgsOpt, node.Type);
            }
            return updatedNode;
        }
        ...
        public override BoundNode? VisitUnconvertedInferredObjectCreationExpression(BoundUnconvertedInferredObjectCreationExpression node)
        {
            ...
            BoundUnconvertedInferredObjectCreationExpression updatedNode;
        ...
        public override BoundNode? VisitObjectCreationExpression(BoundObjectCreationExpression node)
        {
            ...
            if (_updatedNullabilities.TryGetValue(node, out (NullabilityInfo Info, TypeSymbol? Type) infoAndType))
            {
                updatedNode = node.Update(constructor, constructorsGroup, arguments, node.ArgumentNamesOpt, node.ArgumentRefKindsOpt, node.Expanded, node.ArgsToParamsOpt, node.DefaultArguments, node.ConstantValueOpt, initializerExpressionOpt, node.WasTargetTyped, node.OriginalTypeArgsOpt, node.HasDiamondOperator, infoAndType.Type!);
                updatedNode.TopLevelNullability = infoAndType.Info;
            }
            else
            {
                updatedNode = node.Update(constructor, constructorsGroup, arguments, node.ArgumentNamesOpt, node.ArgumentRefKindsOpt, node.Expanded, node.ArgsToParamsOpt, node.DefaultArguments, node.ConstantValueOpt, initializerExpressionOpt, node.WasTargetTyped, node.OriginalTypeArgsOpt, node.HasDiamondOperator, node.Type);
            }
            return updatedNode;
        }
    ...
    internal sealed class BoundTreeDumperNodeProducer : BoundTreeVisitor<object?, TreeDumperNode>
    {
        ...
        public override TreeDumperNode VisitObjectCreationExpression(BoundObjectCreationExpression node, object? arg) => new TreeDumperNode("objectCreationExpression", null, new TreeDumperNode[]
        {
            ...
            new TreeDumperNode("wasTargetTyped", node.WasTargetTyped, null),
            new TreeDumperNode("originalTypeArgsOpt", node.OriginalTypeArgsOpt, null),
            new TreeDumperNode("hasDiamondOperator", node.HasDiamondOperator, null),
            new TreeDumperNode("type", node.Type, null),
            new TreeDumperNode("isSuppressed", node.IsSuppressed, null),
            new TreeDumperNode("hasErrors", node.HasErrors, null)
        }
